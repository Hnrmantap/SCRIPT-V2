...
const exif = new Exif();
//ೋ❀❀ೋ═══[SUBSCRIBE RAMDANI OFFICIAL]═══ೋ❀❀ೋ//
const { downloadMenu, soundMenu, infoMenu, gameMenu, groupMenu, funMenu, wibuMenu, ownerMenu, stickerMenu, otherMenu, rulesBot, islamMenu, sertiMenu, ceritaMenu, makerMenu,dewasaMenu, toolsMenu} = require('./message/help.js')
...
petik = '```'
fake = '© Creator by Ramdani Official'
batre = 'tidak terdeteksi'
api = 'Ramdani Official'
github = 'Ramdani Official'
ban =[]
//ೋ❀❀ೋ═══[SUBSCRIBE RAMDANI OFFICIAL]═══ೋ❀❀ೋ//
// Database
...
module.exports = RAMDANI = async (RAMDANI, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = RAMDANI.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Ramdani Official","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/RAMDANI3.jpg`)},"title": `© Ramdani Official`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Zero YT7", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Zero YT7","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
╰┬———╯          │ ∴°·
 ☆\ˍˍ\_ˍ|—|ˍˍ/ˍˍ/∴☆.`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: 'OWNER'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© Creator by Ramdani Official', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
        ...
        case 'command':
               ...
               listmenuu = [`[🎧]SOUND MENU`,`[🥳]Tahun Baru`,`[🧸]Menu Group`,`[🐥]Wibu Menu`,`[🤡]Sticker Menu`,`[👳]Islam Menu`,`[🕵️]Serti Menu`,`[☂️]Cerita Menu`,`[📦]Maker Menu`,`[🔞]Dewasa Menu`,`[🛂]Owner Menu`,`[🎮]Game Menu`,`[🎣]Fun Menu`,`[📂]Downloader`,`[📰]Info Menu`,`[🪀]MenuLainnya`,`[🦞]Tools Menu`,`[🤖]Info Bot`,`[🐻]Owner`,`[🐛]Stiker Menu`,`[☕]Dowload Menu`,`[🎉]Owner Menu`,`[📝]Nulis Menu`,`[📊]Game Menu`,`[⏰]Grup Menu`,`[☣️]Wibu Menu`]
               nombor = 1
               startnum = 0
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              RAMDANI.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©RAMDANI Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
RAMDANI.sendMessage(from, tapib1, document, { quoted: mek, filename:`Zero YT7 ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `RAMDANI Bot ~ 404 ${vipi}`,
...
"sellerJid": "6289512545999@s.whatsapp.net",
       ...
       case 'welcome':
        ...
        case 'groupsetting':
 		...
 		case 'group':
					...
					break
                    case 'ngaji':
ngaji = fs.readFileSync('./mp3/ngaji.mp3');
RAMDANI.sendMessage(from, ngaji, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sholawatnabi':
sholawatnabi = fs.readFileSync('./mp3/sholawatnabi.mp3');
RAMDANI.sendMessage(from, sholawatnabi, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'tilawah':
tilawah = fs.readFileSync('./mp3/tilawah.mp3');
RAMDANI.sendMessage(from, tilawah, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'assalamualaikum':
assalamualaikum = fs.readFileSync('./mp3/salam.mp3');
RAMDANI.sendMessage(from, assalamualaikum, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ayo':
ayo = fs.readFileSync('./mp3/gakmaump3');
RAMDANI.sendMessage(from, ayo, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound1':
...
break
case 'sound51':
limasatu = fs.readFileSync('./mp3/sound51mp3');
...
break
case 'sound54':
limaempat = fs.readFileSync('./mp3/sound54mp3');
...
break
case 'sound desah':
delapansatu = fs.readFileSync('./mp3/desahan1.mp3');
...
break
case 'sound66':
enamenam = fs.readFileSync('./mp3/sound66mp3');
...
break
case 'sound68':
asu = fs.readFileSync('./mp3/sound68.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound69':
asu = fs.readFileSync('./mp3/sound69.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound70':
asu = fs.readFileSync('./mp3/sound70.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound71':
asu = fs.readFileSync('./mp3/sound71.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound72':
asu = fs.readFileSync('./mp3/sound72.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound73':
asu = fs.readFileSync('./mp3/sound73.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound74':
asu = fs.readFileSync('./mp3/sound74.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound75':
asu = fs.readFileSync('./mp3/sound75.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound76':
asu = fs.readFileSync('./mp3/sound76.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound77':
asu = fs.readFileSync('./mp3/sound77.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound78':
asu = fs.readFileSync('./mp3/sound78.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound79':
asu = fs.readFileSync('./mp3/sound79.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound80':
asu = fs.readFileSync('./mp3/sound80.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound81':
asu = fs.readFileSync('./mp3/sound81.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound82':
asu = fs.readFileSync('./mp3/sound82.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound83':
asu = fs.readFileSync('./mp3/sound83.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound84':
asu = fs.readFileSync('./mp3/sound84.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound85':
asu = fs.readFileSync('./mp3/sound85.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound86':
asu = fs.readFileSync('./mp3/sound86.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound87':
asu = fs.readFileSync('./mp3/sound87.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound88':
asu = fs.readFileSync('./mp3/sound88.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound89':
asu = fs.readFileSync('./mp3/sound89.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound90':
asu = fs.readFileSync('./mp3/sound90.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound91':
asu = fs.readFileSync('./mp3/sound91.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound92':
asu = fs.readFileSync('./mp3/sound92.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound93':
asu = fs.readFileSync('./mp3/sound93.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound94':
asu = fs.readFileSync('./mp3/sound94.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound95':
asu = fs.readFileSync('./mp3/sound95.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound96':
asu = fs.readFileSync('./mp3/sound96.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound97':
asu = fs.readFileSync('./mp3/sound97.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound98':
asu = fs.readFileSync('./mp3/sound98.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound99':
asu = fs.readFileSync('./mp3/sound99.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound100':
asu = fs.readFileSync('./mp3/sound100.mp3');
RAMDANI.sendMessage(from, asu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break                           
//------------------< Menunya Bang:v >-------------------
      case 'dana':
